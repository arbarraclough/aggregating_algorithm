...
\usepackage{algorithm,algpseudocode,amsfonts,amssymb,amsthm,amsmath,graphicx,hyperref,latexsym,titlesec}
...
% \input{sections/on-line_prediction}
% \newpage

% \input{sections/prediction_with_expert_advice}
% \newpage

% \input{sections/specialist_experts}
% \newpage
